...
<p align="center">
  <a href="https://github.com/LearnPrompt/done-lamp/releases/download/v0.4.4/done-lamp-0.4.4.dmg">
    <img src="https://img.shields.io/badge/Download-macOS%200.4.4-F4B400?style=for-the-badge&logo=apple&logoColor=111111" alt="下载 done灯 macOS 0.4.4">
  </a>
...
1. [下载 done-lamp-0.4.4.dmg](https://github.com/LearnPrompt/done-lamp/releases/download/v0.4.4/done-lamp-0.4.4.dmg)，双击打开。
2. 把 `done灯.app` 拖进“应用程序”，再从“应用程序”启动。升级前先退出旧版。
3. 想马上试用，选“仅记录”即可；自动识别可按引导选择模型 API、Codex 或本机 Ollama。

[完整安装与首次使用说明](INSTALL.md) · [0.4.4 更新内容](https://github.com/LearnPrompt/done-lamp/releases/tag/v0.4.4)

## 0.4.4 这次改了什么

- 官方形象依次为 done灯、77、闹闹、OpenAI、DeepSeek。
- 保留原版 done灯；77 是开发者的小猫，闹闹是哈士奇；两个 Logo 保持非拟人图形。
- 团队形象移到设置底部「点亮这盏灯的人」彩蛋，展示卡尔、阿汤、YC 的静态肖像；旧桌宠选择自动回到原版 done灯，保留自定义头像和八状态图片。
- 完整保留已有日报样式、导出颜色修复、桌宠生成、失败诊断与 Codex 连接说明。
...
| 下载文件 | `done-lamp-0.4.4.dmg` · 约 49.0 MB |

这版具体改了什么，可以看 [0.4.4 Release Notes](https://github.com/LearnPrompt/done-lamp/releases/tag/v0.4.4) 和 [CHANGELOG](CHANGELOG.md)。
